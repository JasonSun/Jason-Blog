...
DATABASE_NAME = os.path.join(PROJECT_ROOT, 'blog.db')     # Or path to database file if using sqlite3.
...
ADMIN_MEDIA_PREFIX = '/home/dotcloud/env/lib/python2.6/site-packages/django/contrib/admin/media/'
